               ...
               <div className="max-w-7xl mx-auto px-4 sm:px-6">
                    <div className="flex items-center justify-between h-16">
                         ...
                         <div className="flex items-center gap-1 sm:gap-2">
                              ...
                              {isAuthenticated ? (
                                   <>
                                        <Link to="/profile" className="px-3 py-2 rounded-lg text-sm font-medium hover:bg-primary-800 transition-colors">
                                             Profile
                                        </Link>
                                        ...
                                        <div className="flex items-center gap-2 ml-2 pl-2 border-l border-primary-700">
                                             <span className="text-sm hidden sm:inline text-primary-200">{user?.firstName}</span>
                                             <button onClick={handleLogout} className="px-3 py-1.5 rounded-lg text-sm font-medium bg-primary-800 hover:bg-primary-700 transition-colors">
                                                  Logout
                                             </button>
                                        </div>
                                   </>
