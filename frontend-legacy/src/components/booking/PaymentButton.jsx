...
export default function PaymentButton({ handleSubmit, scheduleId, seatIds, disabled }) {
  ...
  return (
    <Button onClick={handleSubmit(handlePay)} loading={loading} disabled={disabled} className="w-full text-base py-3">
      Confirm & Pay
    </Button>
  );
}